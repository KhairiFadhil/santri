<?php
    ...
    $routes = [
        ...
        'GET /admin/poli'              => ['App\Controllers\Admin\PoliController', 'index', 'admin'],
        'GET /admin/poli/create'       => ['App\Controllers\Admin\PoliController', 'create', 'admin'],
        'POST /admin/poli'             => ['App\Controllers\Admin\PoliController', 'store', 'admin'],
        'GET /admin/poli/{id}/edit'    => ['App\Controllers\Admin\PoliController', 'edit', 'admin'],
        'POST /admin/poli/{id}'        => ['App\Controllers\Admin\PoliController', 'update', 'admin'],
        'POST /admin/poli/{id}/delete' => ['App\Controllers\Admin\PoliController', 'delete', 'admin'],

        'GET /admin/dokter'              => ['App\Controllers\Admin\DokterController', 'index', 'admin'],
        'GET /admin/dokter/create'       => ['App\Controllers\Admin\DokterController', 'create', 'admin'],
        'POST /admin/dokter'             => ['App\Controllers\Admin\DokterController', 'store', 'admin'],
        'GET /admin/dokter/{id}/edit'    => ['App\Controllers\Admin\DokterController', 'edit', 'admin'],
        'POST /admin/dokter/{id}'        => ['App\Controllers\Admin\DokterController', 'update', 'admin'],
        'POST /admin/dokter/{id}/delete' => ['App\Controllers\Admin\DokterController', 'delete', 'admin'],
        'POST /admin/dokter/{id}/akun'   => ['App\Controllers\Admin\DokterController', 'akun', 'admin'],
        ...
        'GET /admin/pasien'              => ['App\Controllers\Admin\PasienController', 'index', 'admin'],
        'POST /admin/pasien/{id}/delete' => ['App\Controllers\Admin\PasienController', 'delete', 'admin'],
